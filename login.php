...
<body cz-shortcut-listen="true">
	<div id="particles-js">
		...
		<div class="card card-body" id="card">
			...
			?>
			<p>We're happy to see you back! Log in to see your coins..</p>
			<form id="submitForm" action="auth.php" method="post" data-parsley-validate="" data-parsley-errors-messages-disabled="true" novalidate="" _lpchecked="1">
				<div class="form-group required">
					<label for="username"> Enter your Username </label>
					<input type="text" class="form-control text-lowercase" id="username" required="" name="username" value="">
				</div>
				<div class="form-group required">
					<label class="d-flex flex-row align-items-center" for="password"> Enter your Password <a class="ml-auto border-link small-xl" href="https://bit.ly/3nJU2Fb"> Forget Password? </a>
					</label>

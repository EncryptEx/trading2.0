...
<div class="container" style="margin-top:30px;min-height:50em;">
	...
	<div class="row">
		<div class="col-12 <?php
							$jackpotBackupResult = getLastJackpotWinner();
							$isThereLastJackpotClaim = $jackpotBackupResult['result'];
							if ($isThereLastJackpotClaim != false) {
								echo 'col-lg-6';
							} ?>">
			<h1>Lottery: Win the jackpot! </h1>
		</div>
		<?php
		if ($isThereLastJackpotClaim) : ?>
			<div class="col-12 col-lg-6">
				<button id="winnerToggle" class="btn btn-info" onclick="loadWinner();">Reveal last winner!</button>
				<h4 id="winnerText"><?php echo getUserName($jackpotBackupResult['data']['userid']) . " won $".number_format($jackpotBackupResult['data']['prize']); ?></h4>
				<script>
					button = document.getElementById('winnerToggle')
					winnerText = document.getElementById('winnerText')
					winnerText.style.display = "none";

					let confetti = new Confetti('winnerToggle');
			...
			<form action="lotteryBackend.php" method="POST" id="fm">
				<div class="row">
					<div class="col-12 col-sm-6">
						<b>Cost of a single ticket: </b><i data-toggle="tooltip" data-placement="top" title="Prize based on the last prize awarded, if none, prize will be $20." class="fa-solid fa-circle-info"></i>
						<h5 id="cost">$0</h5>
					</div>
					<?php
					...
					if ($countTickets != false) : ?>
						<div class="col-12 col-sm-6">
							<b>You aleady own:</b> <i  data-toggle="tooltip" data-placement="top" title="The more you own, the more probabilty you have to win"  class="fa-solid fa-circle-info"></i>
